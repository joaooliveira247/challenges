...
https://www.compareremit.com/money-transfer-tips/
...
def get_leftover_of_bills(amount: float, denomination: float):
    """
...
def exchangeable_value(
    ...
    tax: float = exchange_rate * (spread / 100)
    exchanged: float = exchange_money(budget, exchange_rate + tax)
